...
class HomePage extends Component {
  ...
  handleChange = async value => {
    ...
    console.log("this is viewtime", viewTime);
    ...
    console.log("here is my time", this.time, data, this.state.data);
